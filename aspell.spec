...
%description -l pl
Aspell jest kontrolerem pisowni zaprojektowanym tak, by mÛc zast±piÊ
ispell'a. Dodatkowo zawiera wsparcie dla innych jÍzykÛw niø angielski.
Interfejs aspella napisany zosta≥ w C++, a interfejsy w Perlu i C s±
aktualnie rozwijane.

%package devel
Summary:	Libraries and header files for aspell development
Summary(pl):	Biblioteki i pliki nag≥Ûwkowe dla developerÛw aspella
...
nag≥Ûwkowe dla developerÛw aspella.

%package static
Summary:	Static Libraries for aspell development
Summary(pl):	Biblioteki statyczne dla developerÛw aspella
Group:		Development/Libraries
Group(de):	Entwicklung/Libraries
Group(es):	Desarrollo/Bibliotecas
Group(fr):	Development/Librairies
...
statyczne dla developerÛw aspella.
